...
<template>
    <DialogPortal>
        ...
        <DialogContent
            ...
            :class="
                cn(
                    // Fade only (no zoom/slide): those animate the `transform` property, which
                    // briefly composes with the `-translate-x/y-1/2` centering on this
                    // fixed-position element and can visibly mis-position tall dialogs — most
                    // noticeable on slower devices — until the animation settles.
