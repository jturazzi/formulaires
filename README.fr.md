...
- **Rôles** — administrateurs (gestion des utilisateurs, pages légales et réglages RGPD) et créateurs (gestion de leurs propres formulaires).
...
Les issues et pull requests sont les bienvenues ! Merci de lancer `php artisan test`, `npm run lint` et `npm run format` avant de soumettre.
