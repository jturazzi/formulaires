...
return [
    ...
    'attributes' => [
        ...
        'primary_color' => 'couleur du thème',
        'notification_emails' => 'destinataires des notifications',
        'notification_emails.*' => 'adresse email',
        'max_responses' => 'limite de réponses',
        'expires_at' => 'date de fermeture',
        ...
        'sections.*.description' => 'description de la section',
        'sections.*.fields' => 'questions',
        'sections.*.fields.*.type' => 'type de la question',
        'sections.*.fields.*.label' => 'libellé de la question',
        'sections.*.fields.*.description' => "texte d'aide de la question",
        'sections.*.fields.*.options.choices' => 'choix',
        'sections.*.fields.*.options.choices.*' => 'choix',
        'sections.*.fields.*.options.max_length' => 'nombre de caractères maximum',
        'sections.*.fields.*.options.min' => 'minimum',
        'sections.*.fields.*.options.max' => 'maximum',
        'sections.*.fields.*.options.min_date' => 'date la plus tôt',
        'sections.*.fields.*.options.max_date' => 'date la plus tard',
        'sections.*.fields.*.visibility.mode' => 'mode de visibilité',
        'sections.*.fields.*.visibility.logic' => 'logique de la condition',
        'sections.*.fields.*.visibility.conditions' => 'conditions de visibilité',
        'sections.*.fields.*.visibility.conditions.*.field_id' => 'question conditionnelle',
        'sections.*.fields.*.visibility.conditions.*.operator' => 'opérateur de la condition',
        'sections.*.fields.*.visibility.conditions.*.value' => 'valeur de la condition',
    ],
];
